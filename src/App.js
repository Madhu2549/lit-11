    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/home" element={<Hr_Home />}>
          ...
          <Route
            path="/home/venderRegistration"
            element={<Vender_registration />}
          />
          <Route path="/home/venderSearch" element={<Vendor_Search />} />
          <Route
            path="/home/venderManagement"
            element={<Vender_management />}
          />

          <Route path="/home/internRegistation" element={<Intern_Register />} />
          <Route path="/home/internSearch" element={<Intern_Search />} />
          <Route
            path="/home/internManagement"
            element={<Intern_Management />}
          />
          ...
          <Route
            path="/home/assetsRegistration"
            element={<AssetRegistrations />}
          />
          ...
          <Route
            path="/home/co-wRegistration"
            element={<Co_w_registration />}
          />
          ...
          <Route
            path="/home/requirementSearch"
            element={<RequirementSearch />}
          />
          <Route
            path="/home/requirementManagement"
