...
const Add_Requirement = () => {
  ...
  return (
    <div className="add-requirement-container">
      <h4 className="add-heading">Add Requirement</h4>
      <table className="Req-input">
        <tbody>
          <tr>
            <td>Full Name</td>
            <td>
              <input
                className="req-input-fields"
                type="text"
                name="fullName"
                id="fullName"
                value={fullName}
          ...
          <tr>
            ...
            <td>
              ...
              />
              {clientNameError && (
                <span className="error-message">{clientNameError}</span>
              )}
            </td>
          </tr>
          ...
          <tr>
            <td>Sector</td>
            <td>
              <label htmlFor="dropdown1" className="options">
                Select
              </label>{" "}
              {"\t"}
              {"\t"}
          ...
          {sector === "IT" && (
            <tr>
              <td>IT</td>
              <td>
                <label htmlFor="singleDropdown" className="options">
                  Select an option:
                </label>
                <select
                  id="singleDropdown"
