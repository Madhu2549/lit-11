...
import { itrecruitment } from "../../http-common";
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("candidateinfo", "name", e.target.value)
                    }
                    pattern="[A-Za-z\s]+"
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.candidateinfo.mobileNumber && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.candidateinfo.emailId && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.candidateinfo.higherDegree && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.candidateinfo.passoutYear && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.candidateinfo.collegeName && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.candidateinfo.university && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.candidateinfo.presentLocation && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.candidateinfo.referedBy && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.candidateinfo.source && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.screeningDetails.technology && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.screeningDetails.ctcLpa && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.screeningDetails.experience && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.screeningDetails.expectedCtc && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.screeningDetails.jobType && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.interviewdetails.l1 && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.interviewdetails.l2 && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.interviewdetails.l3 && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    required
                  />
                  {errorMessage && !formData.interviewdetails.hrRound && (
                    <span className="validation-error">{errorMessage}</span>
                  )}
                </td>
              </tr>
