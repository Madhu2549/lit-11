...
function AssetRegistrations() {
  ...
  return (
    <div>
      <div className="title">
        <h2>Asset Registration Information</h2>
      </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        ...
                        onChange={(e) =>
                          handleNormalChairsChange(e.target.value)
                        }
                        pattern="[0-9]*"
                        title="Normal Chairs must contain only numbers"
                        required
                      />
                      {accordionState.Chairs.normalChairs.length > 0 &&
                        !/^[0-9]*$/.test(
                          accordionState.Chairs.normalChairs
                        ) && (
                          <p className="error-message">
                            Normal Chairs must contain only numbers
                          </p>
                        )}
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        ...
                        onChange={(e) =>
                          handleWheelChairsChange(e.target.value)
                        }
                        pattern="[0-9]*"
                        title="Wheel Chairs must contain only numbers"
                        required
                      />
                      {accordionState.Chairs.wheelChairs.length > 0 &&
                        !/^[0-9]*$/.test(accordionState.Chairs.wheelChairs) && (
                          <p className="error-message">
                            Wheel Chairs must contain only numbers
                          </p>
                        )}
                    </td>
                  </tr>
              ...
              <table>
                <tr>
                  ...
                  <td>
                    ...
                    {accordionState.Remote.acRemotes.length > 0 &&
                      !/^[0-9]*$/.test(accordionState.Remote.acRemotes) && (
                        <p className="error-message">
                          AC Remotes must contain only numbers
                        </p>
                      )}
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <input
                      ...
                      required
                    />
                    {accordionState.Remote.fanRemotes.length > 0 &&
                      !/^[0-9]*$/.test(accordionState.Remote.fanRemotes) && (
                        <p className="error-message">
                          Fan Remotes must contain only numbers
                        </p>
                      )}
                  </td>
                </tr>
            ...
            <table>
              <tr>
                <td>
                  ...
                  {accordionState.Pedestals.pedestals.length > 0 &&
                    !/^[0-9]*$/.test(accordionState.Pedestals.pedestals) && (
                      <p className="error-message">
                        Pedestals must contain only numbers
                      </p>
                    )}
                </td>
              </tr>
              ...
              <tr>
                <td>
                  <input
                    ...
                    onChange={(e) =>
                      handleAirConditionersChange(e.target.value)
                    }
                    pattern="[0-9]*"
                  ...
                  {accordionState.AirConditioners.airConditioners.length > 0 &&
                    !/^[0-9]*$/.test(
                      accordionState.AirConditioners.airConditioners
                    ) && (
                      <p className="error-message">
                        AirConditioners must contain only numbers
                      </p>
                    )}
                </td>
              </tr>
              ...
              <table>
                <tr>
                  ...
                  <td>
                    ...
                    {accordionState.OtherAssets.laptops.length > 0 &&
                      !/^[0-9]*$/.test(accordionState.OtherAssets.laptops) && (
                        <p className="error-message">
                          Laptops must contain only numbers
                        </p>
                      )}
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <input
                      ...
                      required
                    />
                    {accordionState.OtherAssets.mouses.length > 0 &&
                      !/^[0-9]*$/.test(accordionState.OtherAssets.mouses) && (
                        <p className="error-message">
                          Mouses must contain only numbers
                        </p>
                      )}
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <input
                      ...
                      required
                    />
                    {accordionState.OtherAssets.chargers.length > 0 &&
                      !/^[0-9]*$/.test(accordionState.OtherAssets.chargers) && (
                        <p className="error-message">
                          Chargers must contain only numbers
                        </p>
                      )}
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <input
                      ...
                      required
                    />
                    {accordionState.OtherAssets.bags.length > 0 &&
                      !/^[0-9]*$/.test(accordionState.OtherAssets.bags) && (
                        <p className="error-message">
                          Bags must contain only numbers
                        </p>
                      )}
                  </td>
                </tr>
              ...
              <tr>
                <td>
                  <input
                    ...
                    required
                  />
                  {accordionState.Fans.fans.length > 0 &&
                    !/^[0-9]*$/.test(accordionState.Fans.fans) && (
                      <p className="error-message">
                        Fans must contain only numbers
                      </p>
                    )}
                </td>
              </tr>
            ...
            <table>
              <tr>
                <td>
                  ...
                  {accordionState.Dustbins.dustbins.length > 0 &&
                    !/^[0-9]*$/.test(accordionState.Dustbins.dustbins) && (
                      <p className="error-message">
                        Dustbins must contain only numbers
                      </p>
                    )}
                </td>
              </tr>
              ...
              <tr>
                <td>
                  <input
                    ...
                    required
                  />
                  {accordionState.Tables.tables.length > 0 &&
                    !/^[0-9]*$/.test(accordionState.Tables.tables) && (
                      <p className="error-message">
                        Tables must contain only numbers
                      </p>
                    )}
                </td>
              </tr>
              ...
              <table>
                <tr>
                  ...
                  <td>
                    ...
                    />
                    {accordionState.Chairs.normalChairs.length > 0 &&
                      !/^[0-9]*$/.test(accordionState.Chairs.normalChairs) && (
                        <p className="error-message">
                          Normal Chairs must contain only numbers
                        </p>
                      )}
